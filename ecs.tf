...
resource "aws_ecs_service" "unity-service" {
    name = "unity-service"

    cluster = aws_ecs_cluster.ecs3.arn
    launch_type = "FARGATE"
    enable_execute_command = true
    ...
    desired_count = 1
    task_definition = aws_ecs_task_definition.td3.arn
...
resource "aws_ecs_task_definition" "td3" {
    ...
    container_definitions = jsonencode([
        {
            ...
            logConfiguration = {
                ...
                options = {
                    ...
                    awslogs-stream-prefix="unity-logs"
                }
